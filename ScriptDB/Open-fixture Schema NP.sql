...
DROP DATABASE IF EXISTS `open_fixtures_np`;
-- Dumping database structure for open_fixtures_np
CREATE DATABASE IF NOT EXISTS `open_fixtures_np` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `open_fixtures_np`;


-- Data exporting was unselected.
-- Dumping structure for table open_fixtures_np.games
...
-- Data exporting was unselected.
-- Dumping structure for table open_fixtures_np.peoples
CREATE TABLE IF NOT EXISTS `users` (
  `id` int(11) NOT NULL,  -- por convenciones de cakephp la clave primaria de todas las tablas se llama "id"
...
-- Data exporting was unselected.
-- Dumping structure for table open_fixtures_np.phases
...
-- Data exporting was unselected.
-- Dumping structure for table open_fixtures_np.scores
...
-- Dumping structure for table open_fixtures_np.teams
