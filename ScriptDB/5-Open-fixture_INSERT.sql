...
INSERT INTO configurations (id,title, short_name, value, created, modified,deleted) VALUES ( 7,'Points by Team Favarite', 'POINTS-TEAM-FAV', '2', now(), now(),0);
INSERT INTO configurations (id,title, short_name, value, created, modified,deleted) VALUES ( 8,'Cat 1 Result Exact', 'POINTS-CAT-UNO', '10', now(), now(),0);
INSERT INTO configurations (id,title, short_name, value, created, modified,deleted) VALUES ( 9,'Cat 2 Win-Goal 1 Team', 'POINTS-CAT-DOS', '6', now(), now(),0);
INSERT INTO configurations (id,title, short_name, value, created, modified,deleted) VALUES ( 10,'Cat 3 Win-Without-Goal', 'POINTS-CAT-TRES', '4', now(), now(),0);
INSERT INTO configurations (id,title, short_name, value, created, modified,deleted) VALUES ( 11,'Cat 4 Goal-1-team', 'POINTS-CAT-CUATRO', '2', now(), now(),0);
COMMIT;
*/
